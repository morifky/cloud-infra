...
### High Level
 ...
 3. I store the Terraform resource model definitions that act as resource templates. 
 
 The idea here is to make it versioned and easy to update later. For example, if AWS releases a new version of the S3 resource, i can just update the model definition, and the service will use the new version automatically.
...
I put the code in the `infrastructure-overlay` folder.
...
I put the code in the `helm` folder.
